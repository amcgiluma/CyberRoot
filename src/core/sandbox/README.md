...
| `noise.py` | Perfil ⚠️ v1 `cd:0, ls:1, cat:1, cp:3, grep:2, wc:1, ps:1, env:1, sudo:3, head:1, tail:1, sort:2, uniq:1, kill:2, cut:1, ssh:2, scp:3` + eventos `common.events.Event` REALES; `exit`/`logout`:0 |
