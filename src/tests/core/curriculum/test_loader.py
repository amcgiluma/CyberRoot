...
def test_load_curriculum_16_conceptos_20_quests() -> None:
    """El catálogo real: 16 conceptos y 20 encargos (01/09 añade cap. 5).

    Conteo del 01/09: 16 (31/08: caps. 0–3, familia procesos) + 4 quests
    `story.ch5.e1`–`e4` (T2, cap. 5 «Subestación», defensa/auditoría). No se
    añaden conceptos nuevos: el cap. 5 reutiliza `chmod`/`chown`/`ps`/`env`/
    `ls-la`/`cat`/`grep` como mantenimiento (§6.0.4), sin botín inédito.
