...
- `[HECHO][P2]` (14/09) **T1 — Seath 19:00 · `feat/meta-ui-2026-09-14` · Web: badge `EN_COLA` se vuelve toggle (lente, no ejecutor) — PR #55** — click → solo `TR-003` (EN_COLA solo), 2º click → 3 filas; reusa `grepFiltered` + `_troncalEnColaOnly`; solo `web/app.js` (42 líneas, TRONCAL_STATIC intacta); consola limpia, restart limpia paneles, Faro intacto; suite 708→708 (delta 0, +1 OK).
