...
- `[HECHO][P2]` (13/09) **T1 — Seath 19:00 · `feat/meta-ui-2026-09-13` · Web: huella del troncal visible** — badge ámbar en fila `TR-003|EN_COLA` + header `id` tachado con tooltip tras `cut -d'|' -f1 | grep TR-`. Solo `web/app.js`; reusa patrón `hideTroncalTabla`/tabla Faro; NO toca `TRONCAL_CONTENT` ni data/. Criterio: visible en `?chapter=4&seed=42`, consola limpia, Faro intacto, 0/+1 tests. → **[HECHO] PR #52 (698 passed, +0, verde) — rama `feat/meta-ui-2026-09-13` lista para Artorias/Gwyn**
