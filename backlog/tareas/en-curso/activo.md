...
- `[HECHO][P3]` (30/08) **T2 — Mecanismo de logros por factura («Cero rastro», «Mano de seda»; OPCIONAL)** — Seath: logros §7.6 como datos del save. Origen: idea de Havel 28/08. **ARTORIAS ✅ (PR #12)**: `evaluate_logros` con 2 logros, persistencia roundtrip, umbral calibrable (`UMBRAL_CERO_RASTRO=4` — ⚠️ quedará por calibrar con O3 del harness).
