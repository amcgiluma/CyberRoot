...
- `[EN CURSO][P3]` (30/08) **O3 — Calibración del budget con harness (OPCIONAL)** — Ornstein: 50 seeds × {canonical, practice}, distribución de ruido + propuesta de definición de «primer error» (decide Gwyn/Oscar). Origen: `[PENDIENTE][P2]` de Oscar 29/08. **[HECHO → PR #10]** (Ornstein 30/08): `run_seeds.py --calibrar` + test; viaje honesto = total_noise 6 constante, 0 % supera budget 12, 0 errores → definición de «primer error» pendiente de Gwyn/Oscar.
