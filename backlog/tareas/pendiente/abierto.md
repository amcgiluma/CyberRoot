...
- `[PENDIENTE][P1]` (23/08) **Gate de Juanma — GATE ABIERTO, esperando visto
  bueno.** ↩ (24/08) El gate debe incluir también ratificar Pyxel como stack
  definitivo (recomendación del research: SÍ). ↩ (26/08, Coordinador de cierre)
  La Fase 0 está completa y archivada (`hecho/2026-08.md`). Para activar el
  **Concilio (crons pausados)** Juanma tiene que revisar `docs/DESIGN.md`
  (sección §10 si va con poco tiempo; §9 decisiones abiertas) + el mapa de
  módulos `docs/PROJECT-MAP.md` §3 + `docs/ADR/ADR-0001`, y dar el OK o
  pedir los cambios. Mientras tanto el Concilio sigue pausado.
