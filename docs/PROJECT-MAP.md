...
|---|---|---|---|
| **Manus** (03:00) | glm-5.3-flash | plan de HOY + `en-curso/activo.md` | `backlog/historia/<...>.md` (story, humanizer). Marca sus piezas `[HECHO]` en `en-curso/activo.md`. |
| **Oscar de Astora** (05:00) | glm-5.3-flash | `zona-testeo.md` + su `ESTADO-JUGADOR.md` | `docs/ESTADO-JUGADOR.md` (run de referencia/veterano) + `[BUG]`/ideas en `tareas/pendiente/abierto.md` + notas de dirección en `notas-manana.md` (🧭). |
| **Havel** (07:00) | glm-5.3-flash | `zona-testeo.md` + `ESTADO-JUGADOR.md` | bugs `[BUG]` + ideas `[PENDIENTE]` en `tareas/pendiente/abierto.md`. Smoke del conjunto SIN save limpio (esa capa es de Oscar). Worklog del día. |
...
| **Ornstein/Smough/Seath** (13/16/19) | glm-5.3-flash | SU línea en `en-curso/activo.md` + plan de HOY | Código en su RAMA `feat/<modulo>` + PR a main. Marcan `[HECHO]` (+PR) junto a su línea en `en-curso/activo.md`. README del módulo. Ornstein: + harness. |
| **Artorias** (21:00) | glm-5.3-flash | `en-curso/activo.md` + `[BUG]` de `pendiente/abierto.md` | 💥/✅ junto a cada línea en `en-curso/activo.md`; aviso + gusto en `notas-manana.md` (🎯); ideas nuevas → `pendiente/abierto.md`. |
