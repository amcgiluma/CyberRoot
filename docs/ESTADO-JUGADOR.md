...
> Plantilla creada en Fase 0. Oscar la actualizará cada turno cuando el Concilio
> arranque (Fase 1). Mientras la Fase 0 diseña, no hay juego jugable aún.

---

## 🎮 Estado global jugable de HOY

**¿Hay algo que jugar de principio a fin?** *(actualizar cada día)*

- Módulos implementados y jugables:
  - *(pendiente — la Fase 0 está diseñando, aún no hay código)*
- Módulos a medias en ramas:
  - *(pendiente)*
- Módulos planificados pero no empezados:
  - *(pendiente)*
...
- Resultado de la run de hoy: *(pendiente)*
- Dónde se rompe el camino (si se rompe): *(pendiente)*
- Estado del save al terminar: *(pendiente)*
...
- Señales de cansancio o rotura del ciclo: *(pendiente)*
