...
> **dos modelos** de `opencode-go`. Todo el Concilio (salvo Gwyn/Gwyndolin en `glm-5.3-flash`) usa **`muse-spark-1.2-contributor`** (1.3 se atraganta con prompts largos, verificado 04/09 — rollback total);
